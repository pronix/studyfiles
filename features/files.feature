...
@green
  Сценарий: Работа с разделом Файлы
    ...
    # TODO: работает, но почему то в тестах нет. Голова уже тупит скорее всего
    # И университет "МГУ" должен быть первый на странице
    И я перейду по ссылке "По рейтингу" 
    # И университет "ПНИПУ" должен быть первый на странице
