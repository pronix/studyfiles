...
#Временное ограничение на длину имени файла 50, потом исправится после прикручивания верстки
  ...
  Сценарий:
    ...
    Тогда я заполню поле "search" значением "Новосибирский государственный университет" 
    И я нажму "search_button"
    #ui steps here
    И я не увижу "Новосибирский государственный университет"
    И я перейду по ссылке "Создать новый"
    Тогда я увижу "Добавить ВУЗ"
    И я заполню поле "abbreviation" значением "НГУ" 
    И я заполню поле "name" значением "Новосибирский государственный университет" 
    И я заполню поле "city" значением "Новосибирск" 
    ...
    Тогда я заполню поле "search" значением "Математический анализ"
    И я нажму "search_button"
    И я не увижу "Математический анализ"
    И я перейду по ссылке "Создать новый"
    ...
    И я увижу "Раздел"
    И я заполню поле "abbreviation" значением "МанАн"
    И я заполню поле "name" значением "Математический анализ"
    И я выберу значение "Математика" в списке "section"
    И я нажму "Создать"
